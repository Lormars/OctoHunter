...
shuffledns -d takeover_domains -w $HOME/wordlist/SecLists/Discovery/DNS/bug-bounty-program-subdomains-trickest-inventory.txt -r $HOME/wordlist/resolvers.txt -mode bruteforce -o shuffle
